...
fun TaskApp() {
    ...
    val colors = if (isDarkTheme) dynamicDarkColorScheme(LocalContext.current) else dynamicLightColorScheme(LocalContext.current)
        ...
        Scaffold(
            ...
            floatingActionButton = {
                FloatingActionButton(
                    ...
                    val icon = if (isDarkTheme) Icons.Default.Favorite else Icons.Default.FavoriteBorder
                    val contentDescription = if (isDarkTheme) "Light Mode" else "Dark Mode"
